...
class SignUp:
    def __init__(self, root):
        ...
        self.bg_img = ImageTk.PhotoImage(file="C:\\Users\\ASUS\\Desktop\\hackathon\\wp5330614.jpg")
    ...
    def signup_func(self):
        if self.fname_txt.get()=="" or self.lname_txt.get()=="" or self.email_txt.get()=="" or self.questions.get()=="Select" or self.answer_txt.get()=="" or self.password_txt.get() == "":
            ...
            try:
                ...
                cur.execute("select * from employee_register where email=%s",self.email_txt.get())
                row=cur.fetchone()
                ...
                if row!=None:
                    ...
                    cur.execute("insert into employee_register (f_name,l_name,email,question,answer,password) values(%s,%s,%s,%s,%s,%s)",
                                    (
                                        self.fname_txt.get(),
                                        self.lname_txt.get(),
                                        self.email_txt.get(),
